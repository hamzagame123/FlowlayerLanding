...
import { GoogleTilesManager } from "./scripts/GoogleTilesManager.js";
...
let tilesManager: GoogleTilesManager;
...
onStart(context => {
    ...
    tilesManager = new GoogleTilesManager(context);
    tilesManager.init();
