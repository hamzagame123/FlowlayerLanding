...
import type { CesiumTilesManager } from "./CesiumTilesManager.js";
...
export class WaypointRoute {
    ...
    private tilesManager: CesiumTilesManager;
    ...
    constructor(context: Context, tilesManager: CesiumTilesManager) {
